...
public class Main {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in); // Bu satır,kullanıcıdan veri almaya sağlayan bir Scanner nesnesi oluşturur.System.in ifadesi,klavyeden giriş yapılacağını belirtir.
